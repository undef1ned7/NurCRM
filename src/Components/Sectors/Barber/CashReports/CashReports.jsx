...
// /* Пагинация — собираем все страницы */
...
//   /* сортированные опции для селектов */
...
//   /* только мастера, встречающиеся в данных (или все, если пусто) */
...
//   /* безопасные даты (автосвап, если перепутали местами) */
...
//     a.href = url;
//     a.download = `cash_${fromSafe || "all"}_${toSafe || "all"}${status ? "_" + status : ""}.csv`;
//     a.click();
...
//       {/* таблица со sticky хедером и внутренним скроллом */}
  ...
  return (
    <div className="cashrep-barber">
      <div className="cashrep-barber__header">
        <h2 className="cashrep-barber__title">Касса · Барбершоп (отчёты)</h2>
        <button
