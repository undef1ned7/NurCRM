...
export const fetchEmployeeByIdApi = async (employeeId) => {
  try {
    ...
    if (error.response) {
      console.error(`Fetch Employee (ID: ${employeeId}) Error Data:`, error.response.data);
      console.error(`Fetch Employee (ID: ${employeeId}) Error Status:`, error.response.status);
      return Promise.reject(error.response.data);
    } 
  }
};
...
export const updateEmployeeApi = async (employeeId, employeeData) => {
  try {
    ...
    if (error.response) {
      console.error(`Update Employee (ID: ${employeeId}) Error Data:`, error.response.data);
      console.error(`Update Employee (ID: ${employeeId}) Error Status:`, error.response.status);
      return Promise.reject(error.response.data);
    } 
  }
};
...
export const deleteEmployeeApi = async (employeeId) => {
  try {
    ...
    if (error.response) {
      console.error(`Delete Employee (ID: ${employeeId}) Error Data:`, error.response.data);
      console.error(`Delete Employee (ID: ${employeeId}) Error Status:`, error.response.status);
      return Promise.reject(error.response.data);
    } 
  }
};